...
public class PlayerServiceImpl implements PlayerService {
    ...
    public void createPlayers() {
        ...
        List<String> hackerNames = Arrays.asList("Cookingking", "Puppylover", "Headshot", "Guitarhero", "Cutiekitten", "Jackedjones", "Spiderman");
        List<String> realNames = Arrays.asList("Tom", "Tilly", "Louis", "Nuha", "Jack", "David", "Beth");
